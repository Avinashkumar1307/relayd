 ...
 *
 * Duplicated in `apps/edge` rather than shared through a package, matching
 ...
 * ## The route label
 *
 * `route` is the matched Express route *pattern*, never `req.path`. The path
 * carries ids: `/api/v1/campaigns/0192f4.../recipients` would be its own
 * series, and a week of normal traffic would produce a series per campaign.
